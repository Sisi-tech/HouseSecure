...
const GetCoverageItem = ({ coverageItem }) => {
    ...
    return (
        <div className='w-full min-w-screen flex flex-col justify-center items-center space-y-2 pl-16 pr-16'>
            <h2 className='font-semibold text-lg text-sky-800'>Coverage</h2>
