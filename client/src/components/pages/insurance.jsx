...
const Insurance = () => {
    return (
        <div>
            ...
            <div className="flex flex-col items-center w-full p-8 text-lg">
                {/* Title */}
                <h1 className="text-2xl lg:text-3xl font-bold pb-4 text-center">Homeowner Insurance Programs</h1>

                {/* Description */}
                <p className="text-lg w-4/5 text-center mb-6">
                ...
                <div className="grid grid-cols-1 text-black md:grid-cols-2 gap-8 w-full lg:max-w-6xl mt-10">
                    ...
                    <div className="bg-gray-50 p-6 rounded-xl shadow-md">
                        <h2 className="text-lg lg:text-xl font-semibold mb-3">📌 Additional Coverage Options</h2>
                        <ul className="leading-loose pl-5 space-y-2">
                ...
                <div className="mt-10 text-center max-w-2xl">
                    <h2 className="text-lg lg:text-xl font-semibold">Get the Right Protection for Your Home</h2>
                    <p className="mt-2">
