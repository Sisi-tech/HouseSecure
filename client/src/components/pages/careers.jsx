        ...
        <div>
            ...
            <div className="flex flex-col gap-8 w-full p-8 text-md">
                ...
                <section className="flex flex-col gap-4 text-center max-w-screen-lg mx-auto">
                    <h1 className="text-md font-semibold pb-1 lg:pb-2">
                ...
                <section>
                    <h2 className="text-md font-semibold pb-6 text-center">🚀 Open Positions</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10 max-w-screen-lg mx-auto">
                        ...
                        <div className="p-6 bg-gray-100 text-gray-900 shadow-md rounded-lg">
                            ...
                            <Link to="/apply/software-engineer" className="bg-blue-600 text-md text-white px-4 py-2 rounded-lg mt-4 inline-block">
                                Apply Now
                            </Link>
                        </div>
                        {/* Position 2 */}
                        <div className="p-6 bg-gray-100 text-gray-900 shadow-md rounded-lg">
                            <h3 className="text-md font-semibold">📞 Customer Support Specialist</h3>
                            ...
                            <Link to="/apply/customer-support" className="bg-blue-600 text-white text-md px-4 py-2 rounded-lg mt-4 inline-block">
                                Apply Now
                            </Link>
                        </div>
                        {/* Position 3 */}
                        <div className="p-6 bg-gray-100 text-gray-900 shadow-md rounded-lg">
                            <h3 className="text-md font-semibold">📊 Data Analyst</h3>
                            ...
                            <Link to="/apply/data-analyst" className="bg-blue-600 text-white text-md px-4 py-2 rounded-lg mt-4 inline-block">
                                Apply Now
                            </Link>
                        </div>
                        {/* Position 4 */}
                        <div className="p-6 bg-gray-100 text-gray-900 shadow-md rounded-lg">
                            <h3 className="text-md font-semibold">📢 Marketing Specialist</h3>
                            <p>Develop strategies to engage our customers and expand our reach.</p>
                            <p className="font-semibold mt-2">📍 Location: Remote</p>
                            <Link to="/apply/marketing-specialist" className="bg-blue-600 text-white text-md px-4 py-2 rounded-lg mt-4 inline-block">
                                Apply Now
                            </Link>
                        </div>
                    </div>
                ...
                <section className="flex flex-col gap-6 max-w-screen-lg mx-auto">
                    <h2 className="text-md font-semibold pb-2 text-center">✨ Why Join HomeSecure?</h2>
                ...
                <section className="flex flex-col gap-6 max-w-screen-lg mx-auto">
                    <h2 className="text-md font-semibold pb-2">📄 How to Apply</h2>
                ...
                <div className="p-6 border-l-4 border-blue-500 bg-blue-100 text-gray-900 max-w-screen-lg mx-auto mt-4">
                    ...
                    <p>Call us at <span className="font-semibold">(888) 888-8888</span> or visit our FAQ page for details.</p>
                </div>

                <p className="text-center text-md font-semibold pt-6">🌟 Ready to Make an Impact? Apply Today!</p>
            </div>
            <BackToTop />
            <Footer />
        </div>
